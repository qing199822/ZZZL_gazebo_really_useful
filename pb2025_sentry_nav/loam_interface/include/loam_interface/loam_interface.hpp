...
private:
  ...
  bool base_frame_to_lidar_initialized_{false};  // L1: class-initialized
  mutable std::mutex state_mutex_;
  // L2: stores base_frame->lidar_frame mount offset (misleading name preserved for compatibility)
