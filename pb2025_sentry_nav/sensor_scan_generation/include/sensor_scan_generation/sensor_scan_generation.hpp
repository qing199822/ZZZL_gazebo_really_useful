...
private:
  ...
  void publishOdometry(
    ...
    const rclcpp::Time & stamp, const geometry_msgs::msg::Twist * upstream_twist = nullptr);
  ...
  // CRITICAL FIX: velocity tracking as member variables (was static local)
  mutable std::mutex velocity_mutex_;
  tf2::Transform previous_transform_;
  rclcpp::Time previous_time_ros_;
